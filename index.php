	...
	<div class="wrapper">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="index.php" class="nav-link">
						<font color="white">
							<b>SISTEM INFORMASI DATA KEPENDUDUKAN DESA DOMIYANG</b>
						</font>
					</a>
				</li>
			</ul>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				...
				<span class="brand-text"> DOMIBASE</span>
			</a>
        ...
        ?>
						...
						<li class="nav-item has-treeview">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item">
									<a href="?page=suket-skck" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Su-Ket SKCK</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="?page=suket-sktm" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Su-Ket SKTM</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="?page=suket-hilang" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Su-Peng Hilang</p>
									</a>
								</li>
								...
								<li class="nav-item">
									<a href="?page=suket-usaha" class="nav-link">
										<i class="nav-icon far fa-circle text-warning"></i>
										<p>Su-Ket Usaha</p>
									</a>
								</li>
      ...
      if(isset($_GET['page'])){
          ...
          switch ($hal) {
				...
				case 'suket-domisili':
					...
					break;
				case 'suket-skck':
					include "surat/suket_skck.php";
					break;
				case 'suket-sktm':
					include "surat/suket_sktm.php";
					break;


				case 'suket-usaha':
					include "surat/suket_usaha.php";
					break;
					
				case 'suket-hilang':
					include "surat/suket_hilang.php";
					break;
				case 'suket-lahir':
