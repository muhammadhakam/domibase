			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<select name="dukuh" id="dukuh" class="form-control">
						<option>- Pilih -</option>
						<option>Madendo</option>
						<option>Sidayu</option>
						<option>Tumiyang 1</option>
						<option>Tumiyang 2</option>
						<option>Kramat</option>
						<option>Pejarakan</option>
					</select>
				</div>
			</div>
...
<?php
    ...
    //mulai proses simpan data
        $sql_simpan = "INSERT INTO tb_pdd (nik, nama, tempat_lh, tgl_lh, jekel, desa, dukuh, rt, rw, agama, kawin, pekerjaan, status) VALUES (
            '".$_POST['nik']."',
            '".$_POST['nama']."',
			'".$_POST['tempat_lh']."',
			'".$_POST['tgl_lh']."',
