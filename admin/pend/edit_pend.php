...
<div class="card card-success">
	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">Dukuh</label>
				<div class="col-sm-3">
					<select name="dukuh" id="dukuh" class="form-control">
						<option value="">-- Pilih Dukuh --</option>
						<?php
                //menhecek data yg dipilih sebelumnya
                if ($data_cek['dukuh'] == "Madendo") echo "<option value='Madendo' selected>Madendo</option>";
                else echo "<option value='Madendo'>Madendo</option>";

                if ($data_cek['dukuh'] == "Sidayu") echo "<option value='Sidayu' selected>Sidayu</option>";
				else echo "<option value='Sidayu'>Sidayu</option>";
				
				if ($data_cek['dukuh'] == "Tumiyang 1") echo "<option value='Tumiyang 1' selected>Tumiyang 1</option>";
                else echo "<option value='Tumiyang 1'>Tumiyang 1</option>";

                if ($data_cek['dukuh'] == "Tumiyang 2") echo "<option value='Tumiyang 2' selected>Tumiyang 2</option>";
                else echo "<option value='Tumiyang 2'>Tumiyang 2</option>";

				if ($data_cek['dukuh'] == "Kramat") echo "<option value='Kramat' selected>Kramat</option>";
                else echo "<option value='Kramat'>Kramat</option>";

				if ($data_cek['dukuh'] == "Pejarakan") echo "<option value='Pejarakan' selected>Pejarakan</option>";
                else echo "<option value='Pejarakan'>Pejarakan</option>";
            ?>
					</select>
				</div>
			</div>
